...
var DiceView = (function () {
    ...
    return {
        ...
        displayWinner: function (activePlayer) {
            ...
            document.querySelector('.player-' + activePlayer + '-panel').insertAdjacentHTML('afterbegin','<ion-icon name="trophy" class="ion-padding-center"></ion-icon>');
            document.querySelector('.player-' + activePlayer + '-panel').insertAdjacentHTML('afterbegin','<ion-icon name="trophy" class="ion-text-center"></ion-icon>');
            document.querySelector('.player-' + activePlayer + '-panel').insertAdjacentHTML('afterbegin','<ion-icon name="trophy" class="ion-text-center"></ion-icon>');
            document.querySelector('.player-' + activePlayer + '-panel').insertAdjacentHTML('beforeend','<ion-icon name="trophy" class="ion-text-center"></ion-icon>');
            document.querySelector('.player-' + activePlayer + '-panel').insertAdjacentHTML('beforeend','<ion-icon name="trophy" class="ion-text-center"></ion-icon>');
            document.querySelector('.player-' + activePlayer + '-panel').insertAdjacentHTML('beforeend','<ion-icon name="trophy" class="ion-text-center"></ion-icon>');


            document.getElementById(DOMstrings.player + activePlayer).textContent = "YOU WIN"; 
        },
